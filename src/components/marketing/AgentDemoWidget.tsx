    ...
    <div className="demo-widget">
      ...
      <div className="flex flex-col items-center justify-center py-10 md:py-16 relative">
        ...
        <button
          ...
          className={`demo-call-btn ${isPlaying ? "demo-call-btn--active" : ""}`}
      ...
      <div className="demo-bottom-bar">
        ...
        <div className="flex items-center gap-0 bg-[var(--m-bg-alt)] border border-[var(--m-border)] rounded-full p-0.5">
          <span className="demo-mode-pill demo-mode-pill--active">Voice</span>
          <span className="demo-mode-pill">Chat</span>
        </div>

        <a
          href="#waitlist"
          className="hidden sm:inline-flex items-center gap-1.5 h-9 px-5 text-[13px] font-semibold bg-[var(--m-accent-bg)] text-[var(--m-accent-fg)] rounded-lg hover:opacity-85 transition-opacity"
        >
          Join waitlist
        </a>
      </div>
