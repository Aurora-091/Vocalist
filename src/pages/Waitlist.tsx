...
function AnimatedStat({ value, label, delay }: { value: string; label: string; delay: number }) {
  ...
  return (
    <div ref={ref}>
      <span className="block font-display font-extrabold text-[clamp(36px,4.5vw,52px)] leading-none tracking-[-0.04em] text-[#0B0B0C]">
        {displayed}
      </span>
      <p className="mt-2 text-[13.5px] text-[#67676C] leading-snug">{label}</p>
    </div>
  );
}
  ...
  return (
    <div className="flex items-center gap-[2px] h-5 flex-1">
      {bars.map((h, i) => (
        <span
          key={i}
          className="waveform-bar w-[2px] rounded-sm bg-[#9A9AA0] flex-none"
          style={{ height: `${h}px` }}
        />
      ))}
    </div>
      ...
      <Dialog open={showSuccess} onOpenChange={setShowSuccess}>
        <DialogContent className="sm:max-w-[460px] p-6 bg-white text-[#0B0B0C] border border-[#E6E5E2] shadow-[0_20px_50px_-34px_rgba(0,0,0,0.35)] [&_button[data-slot=dialog-close]]:text-[#67676C] [&_button[data-slot=dialog-close]]:hover:text-[#0B0B0C]">
          <DialogHeader className="text-left">
            ...
            <DialogDescription className="text-[#67676C] mt-2 text-[14.5px]">
              Want in sooner? Share Weeber and move up the list.
            </DialogDescription>
          </DialogHeader>
          <div className="mt-4 flex items-center gap-3 px-4 py-3 bg-[#F3F2EF] border border-[#E6E5E2] rounded-[9px]">
          ...
          <div className="mt-4 flex gap-2">
            <a
              ...
              target="_blank"
              rel="noopener"
              className="flex-1 text-center border border-[#E6E5E2] rounded-[9px] px-3 py-2.5 text-[13.5px] font-semibold hover:bg-[#F3F2EF] transition-colors"
            >
              WhatsApp
            </a>
            <a
          ...
          <div className="mt-4 border-t border-[#E6E5E2] pt-4">
            <label className="text-[12.5px] text-[#67676C] block mb-2">What do you run? (so we prioritize the right fit)</label>
            <select className="w-full bg-white border border-[#E6E5E2] rounded-[9px] text-[#0B0B0C] text-[14.5px] px-3 py-2.5 focus:outline-none focus:border-[#0B0B0C]">
  ...
  return (
    <div className="marketing min-h-full bg-[#FCFCFB]" ref={revealRef}>
      ...
      <div className="marketing-content">
          ...
          <div className="max-w-[1100px] mx-auto px-6 py-14 md:py-16" data-reveal>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-y-8">
              {STATS.map((s, i) => (
                <div
                  key={s.value}
                  className={`px-6 ${i > 0 ? "sm:border-l border-[#E6E5E2]" : ""} ${i === 2 ? "sm:border-l-0 md:border-l" : ""}`}
                >
        ...
        <section className="border-b border-[#E6E5E2] bg-[#F3F2EF]">
          <div className="max-w-[1100px] mx-auto px-6 py-24 md:py-28">
            <div className="mb-14" data-reveal>
              <span className="inline-flex items-center gap-2 font-mono text-[11px] tracking-[.16em] uppercase text-[#9A9AA0]">
                <span className="w-[6px] h-[6px] rounded-full bg-[#0B0B0C] animate-pulse" />
                Built for how you sell
              </span>
              <h2 className="mt-4 font-display text-[clamp(28px,3.8vw,46px)] font-extrabold tracking-[-0.03em] leading-[1.04] text-[#0B0B0C] max-w-xl">
                Whatever you run, the lost sale is the same — a call that didn't happen.
              </h2>
            </div>
            <div className="grid md:grid-cols-3 gap-px bg-[#E6E5E2] border border-[#E6E5E2] rounded-[18px] overflow-hidden" data-reveal>
              {VERTICALS.map((v, vi) => (
                <div key={v.label} className="bg-[#FCFCFB] p-7 flex flex-col card-lift">
                  <span className="font-mono text-[11px] tracking-[.16em] uppercase text-[#9A9AA0]">{v.label}</span>
                  <h3 className="mt-3 mb-3 font-display text-[21px] font-bold tracking-[-0.02em] leading-snug text-[#0B0B0C]">{v.headline}</h3>
                  ...
                  <div className="mt-5 flex items-center gap-3 border border-[#E6E5E2] rounded-[11px] p-3 bg-white/60">
                    <button
        ...
        <section className="border-b border-[#E6E5E2] bg-[#F3F2EF]">
          <div className="max-w-[1100px] mx-auto px-6 py-24 md:py-28">
            <div data-reveal>
              ...
              <h2 className="mt-4 mb-12 font-display text-[clamp(28px,3.8vw,46px)] font-extrabold tracking-[-0.03em] leading-[1.04] text-[#0B0B0C] max-w-xl">
                Built compliance-first, not bolted on.
              </h2>
            </div>
            <div className="grid md:grid-cols-3 gap-px bg-[#E6E5E2] border border-[#E6E5E2] overflow-hidden" data-reveal>
              {HOW_IT_WORKS.map((step, i) => (
                <div key={step.step} className={`p-8 bg-[#FCFCFB] ${i < HOW_IT_WORKS.length - 1 ? "border-b md:border-b-0 md:border-r border-[#E6E5E2]" : ""}`}>
                  <div className="font-mono text-xs text-[#9A9AA0] mb-5">{step.step}</div>
                  <h3 className="font-display font-bold text-[#0B0B0C] mb-3 text-[17px]">{step.title}</h3>
        ...
        <section className="border-b border-[#E6E5E2] bg-[#FCFCFB]">
          <div className="max-w-[1100px] mx-auto px-6 py-24 md:py-28">
            <div data-reveal>
              ...
              <h2 className="mt-3 font-display text-[clamp(28px,3.8vw,46px)] font-extrabold tracking-[-0.03em] leading-[1.04] text-[#0B0B0C] max-w-2xl">
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-x-7 gap-y-5 mb-14" data-reveal>
              {PLATFORM_FEATURES.map((f) => (
                <div key={f.title} className="flex items-start gap-3">
                  <span className="flex-none mt-0.5 w-[18px] h-[18px]">
                    <svg viewBox="0 0 24 24" fill="none" stroke="#0B0B0C" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12l4 4 10-10" /></svg>
                  </span>
                  <div>
            ...
            <div className="text-center mb-10" data-reveal>
              ...
              <h2 className="mt-3 font-display text-[clamp(24px,3vw,38px)] font-extrabold tracking-[-0.03em] leading-[1.1] text-[#0B0B0C] max-w-xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4" data-reveal>
              <div className="border border-[#E6E5E2] rounded-[16px] p-6 bg-[#FCFCFB] card-lift">
                ...
                <div className="grid grid-cols-4 gap-4">
                  {[
                    ...
                    <div key={t.label} className="flex flex-col items-center gap-2 text-center">
                      <span className={`w-12 h-12 rounded-[13px] border flex items-center justify-center font-display text-[15px] font-extrabold ${t.dark ? "bg-[#0B0B0C] text-white border-[#0B0B0C]" : "bg-white text-[#0B0B0C] border-[#E6E5E2]"}`}>
                        {t.letter}
                      </span>
              ...
              <div className="border border-[#E6E5E2] rounded-[16px] p-6 bg-[#FCFCFB] card-lift">
                ...
                <div className="grid grid-cols-4 gap-4">
                  {[
                    ...
                    <div key={t.label} className="flex flex-col items-center gap-2 text-center">
                      <span className={`w-12 h-12 rounded-[13px] border flex items-center justify-center font-display text-[13px] font-extrabold ${t.dark ? "bg-[#0B0B0C] text-white border-[#0B0B0C]" : "bg-white text-[#0B0B0C] border-[#E6E5E2]"}`}>
                        {t.letter}
                      </span>
                      <span className="text-[11px] text-[#67676C]">{t.label}</span>
                    </div>
              ...
              <div className="border border-[#E6E5E2] rounded-[16px] p-6 bg-[#FCFCFB] md:col-span-2 card-lift">
                <div className="flex items-center gap-2.5 font-semibold text-[14px] mb-5">
                  <span className="w-7 h-7 rounded-[8px] border border-[#E6E5E2] flex items-center justify-center">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {READY_FLOWS.map((f) => (
                    <div key={f} className="flex items-center gap-2.5 bg-[#F3F2EF] border border-[#E6E5E2] rounded-[11px] px-4 py-3.5 text-[14.5px] font-semibold text-[#0B0B0C] hover:bg-white hover:border-[#0B0B0C] transition-colors cursor-default">
                      <span className="w-[6px] h-[6px] rounded-full bg-[#0B0B0C] flex-none" />
                      {f}
                    </div>
                  ))}
                </div>
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div className="flex gap-2 flex-wrap">
                    {["Clinics & local services", "D2C & e-commerce", "Enterprise"].map((t) => (
                      <span key={t} className="border border-[#0B0B0C] rounded-full px-4 py-1.5 text-[13px] font-semibold">{t}</span>
                    ))}
                  </div>
            ...
            <p className="mt-5 text-[14.5px] text-[#67676C]" data-reveal>
              <strong className="text-[#0B0B0C]">Connects to 50+ tools — and counting.</strong> Don't see the one you need?{" "}
              <a href="mailto:hello@weeber.ai" className="link-grow font-semibold text-[#0B0B0C]">Request a connector →</a>
            </p>
          </div>
        </section>
        ...
        <section className="border-b border-[#E6E5E2] bg-[#F3F2EF]">
          <div className="max-w-[1100px] mx-auto px-6 py-24 md:py-28">
            <div data-reveal>
              ...
              <h2 className="mt-4 mb-12 font-display text-[clamp(28px,3.8vw,46px)] font-extrabold tracking-[-0.03em] leading-[1.04] text-[#0B0B0C] max-w-2xl">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4" data-reveal>
              {UPCOMING_VERTICALS.map((v) => (
                <div key={v.title} className="bg-[#FCFCFB] border border-[#E6E5E2] rounded-[15px] p-6 card-lift">
                  <div className="font-mono text-[10px] tracking-[.14em] uppercase text-[#9A9AA0] mb-2">Coming soon</div>
                  <h3 className="font-display text-[17px] font-bold tracking-[-0.02em] text-[#0B0B0C] mb-2">{v.title}</h3>
                  <p className="text-[13.5px] text-[#67676C] leading-relaxed">{v.body}</p>
                </div>
              ))}
            </div>
            <p className="mt-8 text-[16px] text-[#67676C] max-w-[60ch]" data-reveal>
          ...
          <div className="max-w-[1100px] mx-auto px-6 py-24 md:py-28">
            ...
            <div className="grid md:grid-cols-3 gap-4" data-reveal>
              {SECURITY_FEATURES.map((f, i) => {
                ...
                return (
                  <div key={f.title} className="bg-[#FCFCFB] border border-[#E6E5E2] rounded-[15px] p-6 card-lift">
                    <Icon className="w-5 h-5 text-[#0B0B0C]" strokeWidth={1.7} />
                    <h3 className="mt-3 mb-2 font-display text-[16.5px] font-bold text-[#0B0B0C]">{f.title}</h3>
                    <p className="text-[14px] text-[#67676C] leading-relaxed">{f.body}</p>
                  </div>
                );
              })}
            </div>
            <p className="mt-7 text-[14.5px] text-[#67676C]" data-reveal>
          ...
          <div className="max-w-[1100px] mx-auto px-6 py-24 md:py-28">
            <div className="grid md:grid-cols-2 gap-16 items-start" data-reveal>
              <div>
                ...
                <h2 className="mt-3 font-display text-[clamp(28px,3.4vw,40px)] font-extrabold tracking-[-0.03em] leading-[1.08] text-[#0B0B0C]">
        ...
        <section className="border-b border-[#E6E5E2] bg-[#FCFCFB]">
          <div className="max-w-[1100px] mx-auto px-6 py-24 md:py-28">
            <div className="max-w-[760px]" data-reveal>
              ...
              <blockquote className="mt-5 font-display text-[clamp(20px,2.4vw,28px)] font-bold tracking-[-0.02em] leading-[1.4] text-[#0B0B0C]">
              ...
              <div className="mt-6 flex items-center gap-4">
                <span className="w-11 h-11 rounded-full bg-[#0B0B0C] text-white flex items-center justify-center font-display font-bold text-sm flex-none">W</span>
                <div className="flex items-center gap-6">
                  <div>
                    <strong className="text-[15px] font-semibold text-[#0B0B0C]">Ashutosh Pawar</strong>
                    <span className="block text-[13.5px] text-[#67676C]">Co-founder, Weeber</span>
                  </div>
                  <span className="text-[#E6E5E2]">&</span>
                  <div>
                    <strong className="text-[15px] font-semibold text-[#0B0B0C]">Rushikesh Pawar</strong>
                    <span className="block text-[13.5px] text-[#67676C]">Co-founder, Weeber</span>
                  </div>
                </div>
              </div>
        ...
        {/* FAQ */}
        <section id="faq" className="border-b border-[#E6E5E2] bg-[#F3F2EF]">
          <div className="max-w-[1100px] mx-auto px-6 py-24 md:py-28">
            <div data-reveal>
              <span className="inline-flex items-center gap-2 font-mono text-[11px] tracking-[.16em] uppercase text-[#9A9AA0]">
                <span className="w-[6px] h-[6px] rounded-full bg-[#0B0B0C] animate-pulse" />
              ...
              <h2 className="mt-4 mb-10 font-display text-[clamp(28px,3.8vw,46px)] font-extrabold tracking-[-0.03em] leading-[1.04] text-[#0B0B0C]">
            ...
            <div className="max-w-[760px]" data-reveal>
              {FAQ.map((item, i) => (
                <div key={item.q} className={`border-t border-[#E6E5E2] ${i === FAQ.length - 1 ? "border-b" : ""}`}>
                  ...
                  >
                    <span className="font-display font-bold text-[18px] tracking-[-0.01em] text-[#0B0B0C] group-hover:text-[#67676C] transition-colors">{item.q}</span>
